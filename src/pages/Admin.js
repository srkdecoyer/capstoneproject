...
const Admin = () => {
    ...
    const [bookDetails, setBookDetails] = useState({ title: "", description: "", image: "", author: "", price: 0,featured: false });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await API.graphql(graphqlOperation(createProduct, { input: bookDetails }))
            setBookDetails({ title: "", description: "", image: "", author: "", price: 0, featured: false })
        } catch (err) {
                    ...
                    <form className="form-wrapper" onSubmit={handleSubmit}>
                        ...
                        <div className="form-fields">
                            ...
                            <div className="price-form">
                                <p><label htmlFor="price">Price (Rs.)</label>
                                    <input
                                        name="price"
                                        type="text"
                                        placeholder="What is the Price of the book (Rs)"
                                        onChange={(e) => setBookDetails({ ...bookDetails, price: parseFloat(e.target.value) })}
                                        required
                                    /></p>
                            </div>
